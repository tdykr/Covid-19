...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvTotalConfirmed,tvTodaysConfirmed,tvTotalDeaths,tvActive,tvTotalRecovered,tvAffecctedCountry,tvDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText searchCounty = findViewById(R.id.etSearch);
